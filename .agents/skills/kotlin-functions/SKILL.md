...
For every form, check visibility, imports, collisions, and compatibility. For extensions, also check nullable receivers, generics, and future-member precedence. Compile and run `make check` (see [`../../reference/commands.md`](../../reference/commands.md)); on failure, narrow the API or return to step 1.
...
- [`../../reference/coding-conventions.md`](../../reference/coding-conventions.md) — naming and scope-function conventions.
