...
[`DataProcessor.kt`](../../../src/main/kotlin/dev/shtanko/template/DataProcessor.kt), which injects a `CoroutineDispatcher` and exposes `suspend`/`Flow` APIs rather than owning a scope.
